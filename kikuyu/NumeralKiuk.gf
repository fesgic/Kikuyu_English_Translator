concrete NumeralKiuk of Numeral = CatKiuk [Numeral,Digits] ** open Prelude,CommonBantu,DiffKiuk, MorphoKiuk in {
...
lin num x = x ;
lin n2 = mkNumn "ri"   "iri"   "meri" "keri" ;
--lin n3 = mkNum "ithatu"  "atatu" "gatatu" ;
--lin n4 = mkNum "inya"   "ana" "kana" ;
--lin n5 = mkNum "gatano"  "ithano"  "atano" ;
lin n6 = regNum "tandatu" ;
lin n7 = regNum "mugwanja" ;
lin n8 = regNum "inyanya" ;
lin n9 = regNum "kenda" ;

lin pot01 = mkNume "mwe"  " umwe" "kamwe" ** {n = Sg} ;
lin pot0 d = d ** {n = Pl} ;
lin pot110 = regCardOrd "ikumi" ** {n = Pl} ;
lin pot111 = regCardone "ikumi na" "imwe" ** {n = Pl} ; 
...
lin pot2plus d e = {s = table {
 ...
 lin pot2as3 n = n ;
lin pot3 n = { s = table {
      NCard => \\g => mkCard NCard "ngiri" ! g ++ n.s ! NCard ! g ;
      NOrd => \\g =>Ordprefix g++ mkCard NCard "ngiri" ! g ++ n.s ! NCard ! g } ;
              n = Pl} ;
lin pot3plus n m = { s = table {
      NCard => \\g => "ngili" ++ n.s ! NCard !g ++  m.s ! NCard ! g ;
      NOrd => \\g =>Ordprefix g++ "ngiri" ++ n.s ! NCard !g ++  m.s ! NCard ! g} ;
                 n = Pl} ;
