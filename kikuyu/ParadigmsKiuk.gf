...
-- hidden from the document.
  ...
  Gender =  MorphoKiuk.Gender ; 
  Number =  MorphoKiuk.Number ;
  Case =  MorphoKiuk.NPCase ;
  mu_a   = G1 ; --%
  mu_mi  = G2 ;
  i_ma   = G3 ;
  gi_i   = G4 ;
  ...
  regN = MorphoKiuk.regN ; 
  iregN = MorphoKiuk.iregN ;
...
-- shortcut for regular relational nouns with "of".
  ...
  regA : Str -> A = \s -> lin A (MorphoKiuk.regA s) ;
   cregA : Str -> A = \s -> lin A (MorphoKiuk.cregA s) ;
   iregA : (fat,fatter : Str) -> A =\a,b -> lin A (MorphoKiuk.iregA a b);
